...
public class GAME_10 implements GameMap, Listener {
	...
	public void onRegister() {
		spawns.clear();
		World world = Bukkit.getWorld("GAME_10");
	...
	public String getMapName() {
		return "The lost Temple";
	}

	@Override
	public ItemStack getIcon() {
		return ItemSerializer.deserialize("[V=002:SMOOTH_BRICK/³1/³1/³/³/³/³/³/³/³/³/³/³/³/³/³/³]");
	}
