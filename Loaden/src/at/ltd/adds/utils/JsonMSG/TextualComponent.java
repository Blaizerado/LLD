 ...
 * <player>Different instances of this class can be created with static constructor methods.</player>
 */
public abstract class TextualComponent implements Cloneable {
	 ...
	 *							Standard minecraft selectors (@a, @player, etc) are <em>not</em> supported.
	 * @param scoreboardObjective The name of the objective for which to display the score.
