package at.ltd.adds.utils.JsonMSG;

import static at.ltd.adds.utils.JsonMSG.TextualComponent.rawText;
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	 ...
	 * <player>Tooltips do not inherit display characteristics, such as color and styles, from the message component on which they are applied.</player>
	 *
	...
	*/
	 ...
	 * </player>
	 * <player>
	 * Color and formatting can be removed from the returned string by using {@link ChatColor#stripColor(String)}.</player>
	 *
