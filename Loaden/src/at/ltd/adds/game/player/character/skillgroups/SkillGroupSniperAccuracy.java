...
public class SkillGroupSniperAccuracy implements SkillGroup {
	...
	@ConfigAble(key = "", value = "Lvl: [LVL]<newline>Max. Lvl: [MLVL]<newline>Kosten: [COST]<newline>Klasse: [TYPE]<newline>Verbessert die Genauigkeit von Scharfschützengewehre.")
	public String info;
