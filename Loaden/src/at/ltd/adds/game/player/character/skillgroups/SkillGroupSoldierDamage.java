...
public class SkillGroupSoldierDamage implements SkillGroup {
	...
	@ConfigAble(key = "", value = "Lvl: [LVL]<newline>Max. Lvl: [MLVL]<newline>Kosten: [COST]<newline>Klasse: [TYPE]<newline>Veringert den Schaden wenn du getroffen wirst.")
	public String info;
