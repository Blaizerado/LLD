...
public class SkillGroupMedicRegenerationStartingTime implements SkillGroup{
	...
	public String getCodeName() {
		return "MEDIC_REGENERATION_STARTING_TIME";
	}

	@Override
	public String getFrontEndName() {
		return "Heilungs Beginn";
	}
	...
	@ConfigAble(key = "", value = "Lvl: [LVL]<newline>Max. Lvl: [MLVL]<newline>Kosten: [COST]<newline>Klasse: [TYPE]<newline>Verkürzung der Zeit bis zur Regeneration.")
	public String info;
